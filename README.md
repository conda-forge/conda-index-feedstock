...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/conda-index-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/conda-index-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add conda-index
# for installing globally
pixi global install conda-index
```
...
It is possible to list all of the versions of `conda-index` available on your platform:
...
```
pixi search conda-index --channel conda-forge
```
